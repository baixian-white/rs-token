...
A ten-point sweep over $\{-5,-2,0,2,5,7,10,12,15,20\}$~dB shows that the AWGN task gain peaks at 30.70\pp at $+2$~dB and converges to approximately 26.57\pp at high SNR. Under Rayleigh fading, the gain remains approximately 29.4--30.1\pp between $+5$ and $+10$~dB. The distilled and baseline models differ by less than 0.4~dB PSNR over the sweep. At $-5$~dB AWGN, both task accuracies approach the 30-class random level, marking the lower operating boundary of the current hard-decision discrete path.
